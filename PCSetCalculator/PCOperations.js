            ...
            included.forEach(spec => {
                ...
                switch (true) {
                    ...
                    case (spec == 'WF'):
                        ...
                        d.innerHTML = `WF: ${tem['Well-Formed']}<br>Degenerate: ${tem['Well-Formed']? setRep.wellFormed()['Degenerate'] : 'N/A'}<br>Generators: ${tem['Well-Formed']? setRep.wellFormed()['Generators'].toString() : 'N/A'}`;
