...
LibraryItem('Transposition',"Moving a collection of elements by a fixed distance. Typical notation is Tn where n is the OPCI to move all elements upward in pitch-class space. In tonal contexts, transposition maintains the collection's quality. Mathematically, this operation is equivalent to translation. In modular space, this appears visually as rotation.",'{C,E,G} under T4 = {E,G#,B}');
LibraryItem('Inversion',"Moving a collection of elements across a fixed axis. Typical notation can either be In or TnI where: In the In notation n refers to the value to subtract from each pc in the given modular universe. (0-n = pc) and in TnI the set is first inverted about the vertical axis, then transposed by n units upward. The axis of inversion will lie at n(1/2). In tonal contexts, this operation does NOT maintain quality [Not the same as triadic inversion in tonal music]. Mathematically, this operation is equivalent to reflection.","{C,E,G} under I0/T0I = {C,A♭,F}");
